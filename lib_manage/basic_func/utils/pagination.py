...
class Pagination(object):
    ...
    def html(self):
        ...
        page_str_list.append('<li class="page-item"><a class="page-link" href="?{}" aria-label="Previous">首页</a></li>'.format(self.query_dict.urlencode()))
        ...
        # 尾页
        self.query_dict.setlist(self.page_param, [self.total_page_count])
        page_str_list.append('<li class="page-item"><a class="page-link" href="?{}" aria-label="Next">尾页</a></li>'.format(self.query_dict.urlencode()))
